            ...
            <form id="bankForm">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-input" name="latitude" placeholder="Contoh: -6.2088" value="">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-input" name="longitude" placeholder="Contoh: 106.8456" value="">
